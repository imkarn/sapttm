...
<body>
	...
	<article>
		<section id="login-block">
			...
			<form class="form block-content" name="login-form" id="login-form" method="post" action="<?php echo site_url('welcome/sendCode')?>">
			<h1>Register Code</h1>
			<?php
			...
			<?php if (isset($ok)){?>
				...
				<p><button type="submit" class="full-width">Get Register Code</button></p>
...
$(document).ready(function()
{
    ...
    $('#login-form').submit(function(e) {
        ...
        if (!login || login.length == 0){
            $('#login-block').removeBlockMessages().blockMessage('Please enter your user.', {type: 'error'});
            lg.focus();
