...
?>
    <section id="login-block">
        ...
        -->
	<div class="block-header">Register Code</div>
	<?php
	...
	<?php } ?>
                ...
                <?php } ?>
                <form class="form with-margin" name="login-form" id="login-form" method="post" action="<?php echo site_url('welcome/sendCode')?>">
			...
			<p class="inline-small-label">
                        ...
                        ?>
                            ...
                            <button type="submit" class="float-right">Get Register Code</button>
...
$(document).ready(function()
{
    ...
    $('#login-form').submit(function(e) {
        ...
        if (!login || login.length == 0){
            $('#login-block').removeBlockMessages().blockMessage('Please enter your username.', {type: 'warning'});
            lg.focus();
